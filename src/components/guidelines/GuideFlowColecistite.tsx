      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-purple-100 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Antibioticoterapia</h3>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-900">Protocolo de Antibioticoterapia</span>
                  </div>
                  {expandedSections.antibioticos ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
                </div>
              </button>
              ...
              {expandedSections.antibioticos && (
                  <div className="px-4 pb-4 space-y-4">
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <p className="text-sm text-blue-800 mb-2">
                        <strong>Cobertura antimicrobiana recomendada:</strong> Gram-positivos, Gram-negativos e anaeróbios
                      </p>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="border border-gray-200 rounded-lg p-3">
                        <h6 className="font-semibold text-gray-800 mb-2">Primeira Linha (Grau I-II)</h6>
                        <div className="space-y-2 text-sm">
                          <p><strong>Ampicilina/Sulbactam:</strong> 3g IV 6/6h por 7-10 dias</p>
                          <p><strong>Cefazolina + Metronidazol:</strong> 2g IV 8/8h + 500mg IV 8/8h</p>
                          <p><strong>Ciprofloxacino + Metronidazol:</strong> 400mg IV 12/12h + 500mg IV 8/8h</p>
                        </div>
                      </div>
                      
                      <div className="border border-gray-200 rounded-lg p-3">
                        <h6 className="font-semibold text-gray-800 mb-2">Casos Graves (Grau III)</h6>
                        <div className="space-y-2 text-sm">
                          <p><strong>Piperacilina/Tazobactam:</strong> 4,5g IV 6/6h</p>
                          <p><strong>Meropenem:</strong> 1g IV 8/8h</p>
                          <p><strong>Imipenem:</strong> 500mg IV 6/6h</p>
                          <p><strong>Vancomicina + Meropenem:</strong> Se suspeita de MRSA</p>
                        </div>
                      </div>
                      
                      <div className="border border-gray-200 rounded-lg p-3">
                        <h6 className="font-semibold text-gray-800 mb-2">Duração do Tratamento</h6>
                        <div className="space-y-1 text-sm">
                          <p>• <strong>Grau I:</strong> 5-7 dias</p>
                          <p>• <strong>Grau II:</strong> 7-10 dias</p>
                          <p>• <strong>Grau III:</strong> 10-14 dias ou até resolução clínica</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-purple-100 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Protocolo de Seguimento</h3>
            </div>
            
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-3 rounded-lg">
                  <h6 className="font-semibold text-gray-800 mb-2">Monitorização Clínica</h6>
                  <div className="space-y-1 text-sm text-gray-600">
                    <p>• Sinais vitais 6/6h</p>
                    <p>• Dor (escala 0-10)</p>
                    <p>• Sinais de peritonite</p>
                    <p>• Débito urinário</p>
                    <p>• Tolerância alimentar</p>
                  </div>
                </div>
                
                <div className="bg-gray-50 p-3 rounded-lg">
                  <h6 className="font-semibold text-gray-800 mb-2">Exames Laboratoriais</h6>
                  <div className="space-y-1 text-sm text-gray-600">
                    <p>• Hemograma completo (24h)</p>
                    <p>• PCR (48h)</p>
                    <p>• Função renal e hepática</p>
                    <p>• Eletrólitos</p>
                    <p>• Culturas se febre persistente</p>
                  </div>
                </div>
              </div>
              
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <h6 className="font-semibold text-yellow-800 mb-2">Critérios de Piora Clínica</h6>
                <div className="space-y-1 text-sm text-yellow-700">
                  <p>• Febre persistente após 48h de antibiótico</p>
                  <p>• Piora da dor abdominal</p>
                  <p>• Sinais de peritonite</p>
                  <p>• Instabilidade hemodinâmica</p>
                  <p>• Elevação de marcadores inflamatórios</p>
                  <p>• Disfunção orgânica nova</p>
                </div>
              </div>
              
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <h6 className="font-semibold text-green-800 mb-2">Critérios de Alta Hospitalar</h6>
                <div className="space-y-1 text-sm text-green-700">
                  <p>• Afebril por 24h</p>
                  <p>• Dor controlada com analgésicos orais</p>
                  <p>• Tolerância à dieta oral</p>
                  <p>• Normalização dos marcadores inflamatórios</p>
                  <p>• Ausência de complicações</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>Protocolo completo - Revisão final</span>
          </div>
