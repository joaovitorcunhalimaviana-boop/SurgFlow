      ...
      <section className="relative bg-gradient-to-br from-purple-50 via-white to-purple-25 py-24 lg:py-32 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <motion.p
              className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed text-justify"
              variants={fadeInUp}
            >
      ...
      <section className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            {/* GuideFlow */}
            <motion.div
              className="group p-8 rounded-2xl bg-gradient-to-br from-purple-50/70 to-purple-100/70 hover:from-purple-100/70 hover:to-purple-200/70 transition-all duration-300 hover:shadow-xl cursor-pointer"
              initial={{ opacity: 0, x: -40 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 0.5 }}
              whileHover={{ y: -8, boxShadow: "0 20px 40px rgba(147, 51, 234, 0.15)" }}
            >
              <motion.div
          ...
          >
            <motion.div
              className="group p-10 rounded-2xl bg-gradient-to-br from-purple-100/70 to-purple-200/70 hover:from-purple-200/70 hover:to-purple-300/70 transition-all duration-300 border-2 border-purple-300/50 cursor-pointer"
              whileHover={{ y: -8, boxShadow: "0 25px 50px rgba(147, 51, 234, 0.2)" }}
            >
              <div className="flex items-center justify-center mb-8">
                <motion.div
                  className="w-20 h-20 bg-purple-600 rounded-xl flex items-center justify-center"
